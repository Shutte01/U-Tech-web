...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/news/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @if ($post->image)
                    <img src="{{ asset('storage') . '/' . $post->image }}" class="img-preview img-fluid" style="height: 400px; width:1200px; object-fit:cover; overflow: hidden;">
                @else    
